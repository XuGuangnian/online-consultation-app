...
- 定义 [api 函数](https://www.apifox.cn/apidoc/shared-16a58bff-e4db-465c-9c8b-859c839318ac/api-34951413)，以及对应类型
- 实现添加患者业务
...
- 准备按钮
- 定义[API函数](https://www.apifox.cn/apidoc/shared-16a58bff-e4db-465c-9c8b-859c839318ac/api-34951412)
- 点击删除，弹出确认框，确认删除
