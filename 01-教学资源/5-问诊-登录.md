...
<img src="assets/image-20220810200528716.png" alt="image-20220810200528716" style="zoom:80%;" />
...
```html
  <cp-nav-bar title="登陆" right-text="注册"></cp-nav-bar>
  <!-- 表单 -->
  <div class="login">
...
```ts
import { loginByMobile } from '@/services/user'
```
